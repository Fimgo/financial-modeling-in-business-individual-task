...
## 12. Що ще потрібно для повної здачі

Для повного виконання завдання треба мати два основні результати:

1. **Excel-файл із фінансовою моделлю**  
   Це вже зроблено: `Starbucks_Financial_Model.xlsx`.

2. **Текстовий звіт на 5-10 сторінок**  
   Його можна написати на основі цього README та аркушів Excel.

Рекомендована структура текстового звіту:

1. Вступ.
2. Опис Starbucks Corporation.
3. Джерела даних.
4. Методологія побудови моделі.
5. Прогноз доходів і витрат.
6. Спрощений P&L.
